...
procedure TMetadataForm.ControlsToMetadata(AIcon: TIconItem);
begin
...
procedure TMetadataForm.MetadataToControls(AIcon: TIconItem);
begin
  if AIcon = nil then
